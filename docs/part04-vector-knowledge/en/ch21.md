...
Knowledge Engineering, Ontology Modeling, Information Extraction, Entity Linking, Knowledge Graph, GraphRAG
## Learning Objectives

- Be able to determine whether a problem requires vector retrieval or graph-based relational reasoning.
- Be able to design a minimally viable ontology for a business domain, defining core entities and relationships.
- Be able to explain how information extraction and entity linking convert unstructured text into a knowledge graph.
- Be able to explain how GraphRAG combines knowledge graphs and vector retrieval to answer multi-hop relational queries.
...
- Knowledge engineering is not just a RAG plugin; it is a business semantic assetization project.
- Ontologies must be derived from business questions, not only from graph database structures.
...
- [ ] Does GraphRAG output include cited evidence, not just graph paths?
## References
