...
NIST. (2023). [AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework). Google. (n.d.). [Secure AI Framework](https://safety.google/cybersecurity-advancements/saif/).
