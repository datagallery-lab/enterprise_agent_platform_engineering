...
![图 12-1：OLAP 引擎把湖仓数据变成可消费的数据服务](assets/images/ch12-01.png)
...
![图 12-2：企业分析负载决定引擎候选项](assets/images/ch12-02.png)
...
![图 12-3：现代 OLAP 查询执行链路](assets/images/ch12-03.png)
...
![图 12-4：受控湖仓查询先过路由、策略和 Catalog](assets/images/ch12-04.png)
...
![图 12-5：七类湖仓与 OLAP 引擎的系统边界不同](assets/images/ch12-05.png)
...
![图 12-6：性能工程把负载分流到预计算、缓存和探索路径](assets/images/ch12-06.png)
...
![图 12-7：Agent 查询安全边界在引擎提交前生效](assets/images/ch12-07.png)
...
![图 12-8：湖仓查询状态机支撑超时、取消和可解释失败](assets/images/ch12-08.png)
...
![图 12-9：mini-platform 用工作负载标签生成引擎路由决策](assets/images/ch12-09.png)
