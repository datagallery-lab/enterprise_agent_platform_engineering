...
![图 10-1：数据采集层把源系统和 Agent 平台隔离开](assets/images/ch10-01.png)
...
![图 10-2：源系统数据形态决定接入边界](assets/images/ch10-02.png)
...
![图 10-3：采集模式选择先看业务动作和新鲜度](assets/images/ch10-03.png)
...
![图 10-4：CDC 生命周期从初始快照进入增量订阅](assets/images/ch10-04.png)
...
![图 10-5：采集契约把工具状态收敛为平台字段](assets/images/ch10-05.png)
...
![图 10-6：连接器工具应按组织能力和链路职责选择](assets/images/ch10-06.png)
...
![图 10-7：数据采集技术取舍同时看新鲜度、成本和恢复](assets/images/ch10-07.png)
...
![图 10-8：采集失败恢复要同时保留 changelog 和 current 表](assets/images/ch10-08.png)
...
![图 10-9：mini-platform 用规则模型生成采集契约](assets/images/ch10-09.png)
