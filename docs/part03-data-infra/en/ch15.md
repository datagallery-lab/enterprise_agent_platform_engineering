...
OpenLineage. (n.d.). [Documentation](https://openlineage.io/docs/). DataHub. (n.d.). [Documentation](https://datahubproject.io/docs/). Marquez. (n.d.). [Documentation](https://marquezproject.ai/docs/). dbt Labs. (n.d.). [MetricFlow documentation](https://docs.getdbt.com/docs/build/metricflow-time-spine). Cube. (n.d.). [Semantic layer documentation](https://cube.dev/docs/product/semantic-layer).
